...
const ACTIONS = [
  ...
  { key: "create_workout_preset", label: "Criou uma opção de auto preencher", category: "workouts" },
  { key: "update_workout_preset", label: "Editou uma opção de auto preencher", category: "workouts" },
  { key: "delete_workout_preset", label: "Excluiu uma opção de auto preencher", category: "workouts" },
...
const TARGET_TYPES = {
  ...
  workout_presets: "Opção de auto preencher",
  exercises: "Exercício",
