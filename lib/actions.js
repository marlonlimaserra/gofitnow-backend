...
const ACTIONS = [
  ...
  { key: "update_avatar", label: "Trocou a foto de perfil", category: "auth" },
  { key: "delete_avatar", label: "Removeu a foto de perfil", category: "auth" },
  ...
  { key: "create_workout_template", label: "Criou uma opção de auto preencher", category: "workouts" },
  { key: "update_workout_template", label: "Editou uma opção de auto preencher", category: "workouts" },
  { key: "delete_workout_template", label: "Excluiu uma opção de auto preencher", category: "workouts" },
...
const TARGET_TYPES = {
  ...
  workout_templates: "Opção de auto preencher",
  exercises: "Exercício",
