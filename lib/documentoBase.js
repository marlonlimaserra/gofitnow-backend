...
<div style="max-width:760px;margin:0 auto;">
  ...
  <!-- ── O CABEÇALHO: nome à esquerda, logo à DIREITA ────────────────────
       ...
       ── A CHAPA ESCURA MORA DENTRO DO PNG, e não no CSS ──
       
       O wordmark tem o "FitNow" em BRANCO: solto no papel, só o "Go" verde
       aparece. Ele precisa de fundo escuro.
       
       Esse fundo era um "background" aqui, e sumia ao IMPRIMIR: navegador não
       imprime cor de fundo por padrão, e a logo saía invisível — foi o que o
       Marlon viu. "print-color-adjust" resolveria em parte, mas continua à mercê
       da caixa "gráficos de fundo" na janela de impressão.
       
       Assada na imagem, ela é conteúdo, não decoração: imprime sempre, em
       qualquer navegador, com qualquer configuração.
       
       A logo da CASA vai como veio: envolvê-la na nossa chapa poderia brigar com
       a marca de quem escolheu a própria. -->
      ...
      ${
        marca
          ? `<td valign="middle" align="right" width="1" style="padding-bottom:14px;padding-left:16px;">
               <img src="${escapar(marca)}" alt="" height="34" style="max-height:34px;max-width:150px;display:block;" />
             </td>`
          : ""
      }
    </tr>
