...
<div style="max-width:760px;margin:0 auto;">
  ...
  <!-- ── O CABEÇALHO: nome à esquerda, logo à DIREITA ────────────────────
       ...
       A VAFIT (17/09/2026) não precisa de nada disso: o "FIT" é azul-escuro e o
       "VA" é verde, então ela se lê sozinha no branco. A arte trocada é a
       vafit-completo-escuro — símbolo E texto, que foi o pedido: *"precisa
       aparever vafit com o icone"*.
       
       A regra que fica: seja qual for a arte, ela tem de imprimir sem depender
       de cor de fundo. A logo da CASA vai como veio — envolvê-la na nossa chapa
       poderia brigar com a marca de quem escolheu a própria. -->
