...
const PADRAO = {
  ...
  logo: "",
  // ── 44 → 96 em 10/09/2026, junto com a marca nova ──
  //
  // Não é gosto, é aritmética, e ela tem duas partes.
  //
  // A proporção: o wordmark antigo era 5,57:1 e a assinatura da VAFIT é
  // 2,55:1. A mesma altura entrega menos da metade da largura.
  //
  // E a repartição DENTRO da peça, que é o que engana: o corredor ocupa 96%
  // da altura da imagem, mas o "VAFIT" só 60%. Então `logoSize` não é o
  // tamanho do nome — o nome sai em 0,6 disso. A 64 o texto tinha 38 px,
  // MENOS que os 44 do wordmark antigo, que era texto de ponta a ponta.
  //
  // 96 devolve a largura que o logo antigo tinha (≈245 px) e põe o nome em
  // 58 px. Passei por 64 antes e ficou pequeno na tela — medido, não achado.
  //
  // Só afeta quem NÃO escolheu tamanho: quem já mexeu tem o valor salvo.
  logoSize: 96,
