...
const PADRAO = {
  ...
  //
  // ── 10/09/2026: passou a ser o azul da VAFIT ──
  //
  // `#1a4085` é o azul medido do logo novo — o "VA" do wordmark. Era
  // `#0ea5e9`, o ciano, que continua existindo como preset `oceano`.
  //
