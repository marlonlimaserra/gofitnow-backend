...
const PADRAO = {
  ...
  //
  // É uma cor CLARA, e isso importa: o front escolhe o texto do botão comparando
  // contraste (`--brand-fg`), então trocar este padrão por um tom escuro devolve
  // texto branco sozinho.
  brand: "#0ea5e9",
