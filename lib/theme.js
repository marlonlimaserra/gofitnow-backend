...
const PADRAO = {
  ...
  logo: "",
  // ── 44 → 64 em 10/09/2026, junto com a marca nova ──
  //
  // Não é gosto, é proporção. O wordmark antigo era 5,57:1 e a assinatura da
  // VAFIT é 2,55:1 — a MESMA altura entrega menos da metade da largura, e na
  // tela de entrar o logo ficou pequeno de um dia para o outro sem ninguém
  // ter mexido em nada.
  //
  // 64 devolve presença sem chegar aos 96 que igualariam a largura antiga —
  // essa altura empurraria o cartão de login para baixo da dobra no celular.
  //
